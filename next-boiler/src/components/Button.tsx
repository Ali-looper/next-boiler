...
const Button: React.FC<ButtonProps> = ({ 
    ...
    const variantStyles = {
      ...
      outline: "border border-neutral-200 text-neutral-200 hover:bg-neutral-200 hover:text-black",
  ...
  return (
    <button
      className={`${backgroundColor} ${variantStyles[variant]} ${sizeStyles[size]} ${textColor} ${width} ${height} rounded-2xl shadow-sm transition-all 
        ${disabled || loading ? "cursor-not-allowed bg-gray-300 text-gray-500" : "hover:bg-gray-300"} ${className}`}
